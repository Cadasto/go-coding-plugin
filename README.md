...
An AI plugin by **Cadasto B.V.** that teaches AI coding assistants **idiomatic Go coding standards** — formatting, naming, error handling, concurrency, testing, and project layout — through skills, an agent, a session-start hook, and a Cursor rule. It targets **both Claude Code and Cursor** from a single shared component set.
